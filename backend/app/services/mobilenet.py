"""MobileNet — Keras 3 compatible version of the original nets/mobilenet.py.

Layer names are preserved exactly so pretrained .h5 weights load correctly.
"""
...
def relu6(x):
    """ReLU6: clip(x, 0, 6)."""
    return ops.minimum(ops.maximum(x, 0), 6)
